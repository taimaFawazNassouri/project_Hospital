    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('Sections.index') }}">{{trans('Dashboard/main-sidebar_trans.view all')}}</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">Flot</a></li>
